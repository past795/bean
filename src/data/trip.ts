...
export const initialTrip: TripDay[] = [
  ...
  },
  {
    ...
    stops: [
      ...
      s("d3-paper-garden", "16:05", "Paper Garden", "부산광역시 부산진구 전포대로210번길 8 2층", "步行", "生活、植物與居家小物；Visit Busan 資料為每日 11:00–22:00。"),
      s("d3-bracket-table", "16:50", "Bracket Table", "부산광역시 부산진구 서전로68번길 109 1층", "步行", "餐廚與生活選物；約 20:00 關門，不排太晚。"),
      s("d3-free-shopping", "17:35", "田浦選物店自由逛", "부산광역시 부산진구 전포카페거리", "步行", "保留補逛與臨時發現店家的時間；Hertz35 因目前無法確認地址，暫不列為固定站。"),
      s("d2-10", "19:00", "Old Mansion", "부산광역시 부산진구 전포대로209번길 17-6 1층", "步行", "由 10/5 移至 10/6，作為晚餐。"),
